...
fn create_python_project(_command: &str, _language: &str, _project_type: Option<&str>, project_name: &str, path: Option<&str>) {
...
fn main() {
    ...
    if command == "create" {
        create_python_project(command, language, project_type, project_name, path);
    } else {
